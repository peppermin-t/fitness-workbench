...
- 桌面壳加载的是由 `src/app/index.html` 生成的 `dist/desktop/index.html`，以及 `data.js`、`dist/desktop/src/core/rules/*.js`、`dist/desktop/src/core/rules/facade.js`、`planner.js`、`app.js`。
